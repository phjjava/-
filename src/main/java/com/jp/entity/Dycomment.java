...
public class Dycomment extends DycommentKey implements Serializable {
	/**
	 * 评论时间
	 */
	...
	public void setTopparentid(String topparentid) {
		this.topparentid = topparentid == null ? null : topparentid.trim();
	}
	...
	public String toString() {
		...
		sb.append(", relusername=").append(relusername);
