...
public interface MomentUserFilterMapper {
	...
	int updateByExampleSelective(@Param("record") MomentUserFilter record,
			@Param("example") MomentUserFilterExample example);
	...
	int insertBatch(List<MomentUserFilter> list);
}