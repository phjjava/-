...
public class CalendarUtil {
	...
	public static void main(String[] args) throws Exception {
		//阴历转阳历
		System.out.println(CalendarUtil.lunarToSolar("2019-07-06", false));
		System.out.println(CalendarUtil.lunarToSolar("1984-10-21", true));
		System.out.println("************");
		//阳历转农历
		System.out.println(CalendarUtil.solarToLunar("1900-01-30"));
	}
