...
public class SDKClientProxy implements com.cn.b2m.eucp.sdkhttp.SDKClient {
  private String _endpoint = null;
  private com.cn.b2m.eucp.sdkhttp.SDKClient sDKClient = null;
  ...
  private void _initSDKClientProxy() {
    try {
      sDKClient = (new com.cn.b2m.eucp.sdkhttp.SDKServiceLocator()).getSDKService();
      if (sDKClient != null) {
        if (_endpoint != null)
  ...
  public com.cn.b2m.eucp.sdkhttp.SDKClient getSDKClient() {
    if (sDKClient == null)
      _initSDKClientProxy();
    return sDKClient;
  }
