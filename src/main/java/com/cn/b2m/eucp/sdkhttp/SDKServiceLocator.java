...
public class SDKServiceLocator extends org.apache.axis.client.Service implements com.cn.b2m.eucp.sdkhttp.SDKService {
	...
	private java.lang.String SDKService_address = PropertyResourceBundle.getBundle("conf/config").getString("uri");
	...
	public com.cn.b2m.eucp.sdkhttp.SDKClient getSDKService(java.net.URL portAddress)
			throws javax.xml.rpc.ServiceException {
		try {
			com.cn.b2m.eucp.sdkhttp.SDKServiceBindingStub _stub = new com.cn.b2m.eucp.sdkhttp.SDKServiceBindingStub(
					portAddress, this);
