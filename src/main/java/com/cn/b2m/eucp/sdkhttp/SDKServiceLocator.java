...
public class SDKServiceLocator extends org.apache.axis.client.Service implements com.cn.b2m.eucp.sdkhttp.SDKService {
...
//    private java.lang.String SDKService_address = "http://116.58.219.223:8081/sdk/SDKService";
    ...
    public com.cn.b2m.eucp.sdkhttp.SDKClient getSDKService() throws javax.xml.rpc.ServiceException {
    ...
    public com.cn.b2m.eucp.sdkhttp.SDKClient getSDKService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
        	com.cn.b2m.eucp.sdkhttp.SDKServiceBindingStub _stub = new com.cn.b2m.eucp.sdkhttp.SDKServiceBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.cn.b2m.eucp.sdkhttp.SDKClient.class.isAssignableFrom(serviceEndpointInterface)) {
            	com.cn.b2m.eucp.sdkhttp.SDKServiceBindingStub _stub = new com.cn.b2m.eucp.sdkhttp.SDKServiceBindingStub(new java.net.URL(SDKService_address), this);
                _stub.setPortName(getSDKServiceWSDDServiceName());
                return _stub;
            }
        }
