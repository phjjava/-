	  ...
	  <input type="hidden" value="${event.imgurl}" name="imgurl" id="imgurl">
				...
				<div class="uploader-list-container"> 
					<div class="queueList">
						<div id="dndArea" class="placeholder">
							...
							<div>仅支持单张上传，图片格式为jpg或png，图片比例7：2（建议尺寸950×270px），大小不超过50M</div>
						</div>
					</div>
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2" style="text-align:right">
				<input class="btn btn-primary radius" type="button" onclick="eventSave();" value="确认" style="width:120px;">
...
(function( $ ){
    ...
    $(function() {
        ...
        uploader = WebUploader.create({
            ...
            chunked: false,
            chunkSize: 512 * 1024,
            server: '<%=basePath%>event/savePhoto',
