...
<form action="" method="post" class="form form-horizontal" id="form-sysfunction-add">
	...
	<input type="hidden" value="${menu.imgurl}" name="imgurl" id="imgurl">
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-2">名称：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text"  value="${menu.name}" name="name">
		</div>
	</div>
	 
 	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-2">图标上传：</label>
		<div class="formControls col-xs-8 col-sm-9">
	...
	<!-- 
	 <div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="${index.imgurl}" name="duration">
		</div>
	</div>
	 -->
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-2">识别码：</label>
		<div class="formControls col-xs-8 col-sm-9">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="${menu.sort}" name="sort">
		</div>
	</div>
...
function save(){
	if($("#form-sysfunction-add").valid()){
		...
		$.ajax({
			...
			url : '<%=basePath%>system/functionMenu/save?curSec='+Math.random(),
			success:function(data){
				if(data == '1'){
					window.parent.searchChildList();
