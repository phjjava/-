...
<article class="page-container">
	...
	<input type="hidden" id="familyid"  name="familyid" value="${usercontent.familyid}"/>
	 <%--  <input type="hidden" id="userid" name="userid" value="${usercontent.userid}"/>  --%>
				<input type="hidden" class="input-text"  value="${usercontent.imgurl}" id="bannerphoneurl" name="imgurl">
				<input type="hidden" class="input-text"  value="${usercontent.imgurl}" id="bannerweburl" name="imgurlback">
	    <div class="row cl">
		...
		<div class="row cl" id="showImg">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<img src="" style="width:190px;height:150px;background-color:#f8f8f8;margin:15px 7px 0 7px;"  id="preImg" />
			</div>
		</div>		
		<div class="row cl">
				...
				<div class="uploader-list-container">
					...
					<div class="queueList">
						<div id="dndArea" class="placeholder">
							...
							<div style="margin-bottom:90px;">仅支持单张上传，图片格式为jpg或png，图片比例为5:4（建议尺寸350×280px），大小不超过50M</div>
						</div>
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2" style="text-align:right">
				<button onclick="content_save();" class="btn btn-primary radius" style="width:120px;"><i class="Hui-iconfont">&#xe632;</i> 保存</button>
...
//下拉栏选择change事件给隐藏familyid赋值
$("#userid").change(function(){
	  $("#familyid").val($("#userid option:selected").attr("familyid"));
	});
    ...
    if(sort==''){
 	...
 	if($("#famous_edit").valid()){
		$.ajax({
			...
			async: true,
			data:formData,
			url : '<%=basePath%>famous/save?curSec='+Math.random(),
