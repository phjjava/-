...
<article class="page-container">
	<form class="form form-horizontal" id="banner_add">
	  <input type="hidden" id="bannerid" name="bannerid" value="${banner.bannerid}"/>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">作品集标题：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${banner.bannername}" id="bannername" name="bannername">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">作品集简介：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<textarea style="width:100%;height:60px; border:1px solid #dddddd"></textarea>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">上传作品：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<div class="uploader-list-container"> 
					<div class="queueList">
						<div id="dndArea" class="placeholder">
							<div id="filePicker-2"></div>
							<p>或将照片拖到这里，最多上传300张，图片格式为jpg或png，大小为750×320像素</p>
						</div>
					</div>
