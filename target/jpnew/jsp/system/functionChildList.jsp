...
<div class="Hui-article">
	<article class="cl pd-20">
		<div class="cl pd-5 bg-1 bk-gray">
			<span class="l">
			<a class="btn btn-primary radius" href="javascript:;" onclick="function_add('新增菜单','<%=basePath%>jsp/system/functionChild.jsp?parentid=${parentid}','800')">
		...
		<div class="mt-20">
			<div id="DataTables_Table_0_wrapper" class="dataTables_wrapper no-footer">
				<table class="table table-border table-bordered table-hover table-bg">
					...
					<tbody>
						<c:forEach var="sysFunction" items="${childList }" varStatus="status">
							<tr class="text-c">
...
function sysFunction_edit(title,functionid,id,w,h){
	var url = basePath + 'system/sysfunction/getchild?functionid='+functionid+'&curSec='+Math.random();
	layer_show(title,url,w,h);
} 
//查询方法
